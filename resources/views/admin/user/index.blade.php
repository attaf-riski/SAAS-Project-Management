                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable">
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="d-flex gap-3 justify-content-center">
                                        <a href="#" class="btn btn-secondary" data-bs-toggle="modal"
                                            data-bs-target="#modal_edit-{{ $user->id }}">
                                            Edit
                                        </a>
                                        <a href="#" class="btn btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#modal_hapus-{{ $user->id }}">
                                            Delete
                                        </a>
                                    </td>
                                </tr>
                                {{-- edit modal --}}
                                <div class="modal modal-blur fade" id="modal_edit-{{ $user->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="fullname"
                                                            placeholder="Fill with name" value="{{ $user->fullname }}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Email</label>
                                                        <input type="email" class="form-control" name="email"
                                                            placeholder="Fill with email" value="{{ $user->email }}">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="profession"
                                                            placeholder="Fill with profession"
                                                            value="{{ $user->profession }}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Experience Level (years)</label>
                                                        <input type="number" class="form-control" name="experience_level"
                                                            placeholder="Fill with Experience Level"
                                                            value="{{ $user->experience_level }}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Organization</label>
                                                        <input type="text" class="form-control" name="organization"
                                                            placeholder="Fill with Organization"
                                ...
                                {{-- modal hapus --}}
                                <div class="modal modal-blur fade" id="modal_hapus-{{ $user->id }}" tabindex="-1"
                                    role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-center py-4">
                                                ...
                                                <h3>Are you sure?</h3>
                                                <div class="text-muted">Do you really want to remove the user? What you've
