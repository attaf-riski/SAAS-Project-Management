...
@section('body')
    ...
    <div class="col-md">
        <div class="col">
            ...
            <a href="{{ route('workspace.invoices.createfromclient', ['id' => $client->id]) }}"
                class="btn btn-primary mt-3">Invoice Client</a>
            <a href="#" class="btn btn-secondary mt-3 dropdown-toggle" data-bs-toggle="dropdown"
        ...
        <div class="card mt-4">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="#notes" class="nav-link" data-bs-toggle="tab" aria-selected="false" role="tab"
                            tabindex="-1">Notes</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <a href="#tabs-to-do" class="nav-link active" data-bs-toggle="tab"
                                                    aria-selected="false" role="tab" tabindex="-1">To Do</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div class="tab-pane fade active show" id="tabs-to-do" role="tabpanel">
                                                <table
                                                    class="table card-table table-vcenter text-nowrap datatable table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th class="w-1"></th>
                                                            <th>Title</th>
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="circle-icon">
                                                                        <form
                                                                            action="{{ route('workspace.clients.tasks.destroy', $task->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button class="btn">
                                                        ...
                                                        @endforeach
                                                        <form
                                                            action="{{ route('workspace.clients.send.tasks', $client->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <tr>
                                                                <td></td>
                                                                <td><input class="form-control" type="text"
                                                                        name="tasks" placeholder="Title"></td>
                                                                <td><input type="date" class="form-control"
                                                                        name="tasks_due_date"></td>
                                ...
                                <form action="{{ route('workspace.clients.update', ['id' => $client->id]) }}"
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" disabled=""
                                                placeholder="Company" value="{{ $client->name }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-2">
                                            ...
                                            <textarea rows="3" class="form-control" name="address" placeholder="Here can be your description"
                                                value="Mike">{{ $client->address }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="no_telp"
                                                placeholder="No Telephone" value="{{ $client->no_telp }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-5">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="region"
                                                placeholder="Province" value="{{ $client->region }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="test" class="form-control" name="postal_code"
                                                placeholder="ZIP Code" value="{{ $client->postal_code }}">
                                        </div>
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            @php
                                                // $i = 1;
                                                $i =
                                                    1 + ($projectmodels->currentPage() - 1) * $projectmodels->perPage();
                                            @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($project->status == 'ACTIVE')
                                                            <span
                                                                class="badge text-bg-success">{{ $project->status }}</span>
                                                        @elseif($project->status == 'PENDING')
                                                            <span
                                                                class="badge text-bg-warning">{{ $project->status }}</span>
                                                        @elseif($project->status == 'ENDED')
                                                            <span
                                                                class="badge text-bg-danger">{{ $project->status }}</span>
                                                        @endif
                                                    </td>
                                                    <td>{{ $client->name }}</td>
                                                </tr>
                    ...
                    <div class="tab-pane" id="notes" role="tabpanel">
                        <form action="{{ route('workspace.clients.update.notes', ['id' => $client->id]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
    ...
    {{-- Modal Hapus --}}
    <div class="modal modal-blur fade" id="modalDelete-{{ $client->id }}" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="w-100">
                        <div class="row">
                            <form action="{{ route('workspace.clients.delete', ['id' => $client->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')
    ...
    {{-- Modals Edit --}}
    <div class="modal modal-blur fade" id="modalEdit-{{ $client->id }}" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{ route('workspace.clients.update.name', ['id' => $client->id]) }}" method="POST"
