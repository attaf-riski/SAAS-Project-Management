                        ...
                        <fieldset class="form-fieldset">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="invoice_type" id="invoice_type">
                                    <option value="once" {{ $project->invoice_type === 'once' ? 'selected' : '' }}>Once</option>
                                    <option value="hourly" {{ $project->invoice_type === 'hourly' ? 'selected' : '' }}>Hourly</option>
                                    <option value="daily" {{ $project->invoice_type === 'daily' ? 'selected' : '' }}>Daily</option>
                                    <option value="weekly" {{ $project->invoice_type === 'weekly' ? 'selected' : '' }}>Weekly</option>
                                    <option value="monthly" {{ $project->invoice_type === 'monthly' ? 'selected' : '' }}>Monthly</option>
                                    <option value="custom" {{ $project->invoice_type === 'custom' ? 'selected' : '' }}>Custom</option>
                                </select>
                            </div>
                        </fieldset>
